...
namespace QuanLyBanSach.Data.Migrations
{
    ...
    [Migration("20171202071224_AddTraLoiLienLacTable")]
    partial class AddTraLoiLienLacTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyBanSach.Models.LienLac", b =>
                {
                    ...
                    b.Property<int?>("traLoiLienLacId");

                    b.HasKey("Id");

                    b.HasIndex("traLoiLienLacId")
                        .IsUnique()
                        .HasFilter("[traLoiLienLacId] IS NOT NULL");
            ...
            modelBuilder.Entity("QuanLyBanSach.Models.LienLac", b =>
                {
                    b.HasOne("QuanLyBanSach.Models.TraLoiLienLac", "traLoiLienLac")
                        .WithOne("LienLac")
                        .HasForeignKey("QuanLyBanSach.Models.LienLac", "traLoiLienLacId");
                });
